...
function prepareFunc(r) {
	return prepareNamedData(gowtfData.funcs, r.arg1, r.dot || r.bang)
}
...
function prepareType(r) {
	return prepareNamedData(gowtfData.types, r.arg1, r.dot || r.bang)
}
...
function prepareConst(r) {
	return prepareData(gowtfData.consts, r.arg1, r.dot || r.bang, constScore, constScoreSort)
}
...
function prepareVar(r) {
	return prepareData(gowtfData.vars, r.arg1, r.dot || r.bang, valueScore, varScoreSort)
}
...
function prepareMethod(r) {
	var bestmatch = []
	if (r.arg1 != "")
		bestmatch = findBestMatch(gowtfData.types, r.arg1, namedScore)
